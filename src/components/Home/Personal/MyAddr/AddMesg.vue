<template>
  <div class="Addmsg">
    <div class="lebble">
      <span>
          <p class="tex3"> 收货人姓名：</p><p class="iconfont icon-shanhuxiaerqi tex1"></p>
      </span>
      <span class="tex2">
           <p class="tex3">所在地区：</p><p class="iconfont icon-shanhuxiaerqi tex1"></p>
      </span>
      <span class="tex2">
    ...
    <div class="InpTex">
        ...
        <div class="defaultAddr">
            <template>
              <el-radio v-model="radio" label="1">设为常用地址</el-radio>
            </template>
        </div>
